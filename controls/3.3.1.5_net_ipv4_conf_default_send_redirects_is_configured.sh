...
execute_control() {
    ...
    local EXPECTED="Verify net.ipv4.conf.default.send_redirects is set to 0.
1. Run the following command to verify
net.ipv4.conf.default.send_redirects is set to 0 in the running
configuration:
# sysctl net.ipv4.conf.default.send_redirects
Verify output is:
net.ipv4.conf.default.send_redirects = 0
2. Run the following script to verify net.ipv4.conf.default.send_redirects =
...
Example output:
- \"net.ipv4.conf.default.send_redirects = 0\" is set in: \"/etc/sysctl.d/60ipv4_sysctl.conf\"
Note:
•
•
•
